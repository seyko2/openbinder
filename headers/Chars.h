...
/*!
	@file Chars.h
	@ingroup CoreEventMgr
	@brief Standard character codes, including hard keyboard characters.
*/
...
// New platform virtual characters for phones.
...
// Japanese keyboards have some more keys
